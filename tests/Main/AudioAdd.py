...
class AudioAdd(Component):
    ...
    def before_click(self):
        before_number = Lib.visibility_wait_element(self.driver, self.MUSIC_NUMBER).text
    ...
    def after_click(self):
        ...
        after_number = Lib.visibility_wait_element(self.driver, self.MUSIC_NUMBER).text
        return after_number
